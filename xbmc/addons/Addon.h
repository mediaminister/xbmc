...
public:
  ...
  */
   ...
   */
  bool MeetsVersion(const AddonVersion& versionMin, const AddonVersion& version, const AddonVersion& versionMax) const override
  {
    return m_addonInfo->MeetsVersion(versionMin, version, versionMax);
  }
